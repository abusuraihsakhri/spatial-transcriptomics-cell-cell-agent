"""
Data Models & Telemetry Definitions for SpatialCellComm: Ligand-Receptor Interaction & Spatial Proximity Agent.
...
class AgentTelemetryAlert:
    ...
    standard_reference: str = "Spatial Transcriptomics & CellChat Protocols"
    timestamp: str = field(default_factory=lambda: datetime.datetime.now(datetime.timezone.utc).isoformat())
