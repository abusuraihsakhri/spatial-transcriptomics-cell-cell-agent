"""
FastAPI REST API Server for SpatialCellComm: Ligand-Receptor Interaction & Spatial Proximity Agent.
"""
...
def create_app():
    try:
        ...
        app = FastAPI(
            title="SpatialCellComm: Ligand-Receptor Interaction & Spatial Proximity Agent",
            description="Integrates 10x Visium / CosMx spatial coordinates with CellChat ligand-receptor pairs to identify cell-cell communication hubs.",
        ...
        @app.get("/health")
        def health():
            return {"status": "HEALTHY", "system": "spatial-transcriptomics-cell-cell-agent", "domain": "Biomedical Scientific Discovery & Multi-Omics", "version": "2.0.0-FRONTIER"}
