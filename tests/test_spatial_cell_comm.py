...
import pytest
from spatial_cell_comm.models import FrontierPayload, ExecutionStatus
from spatial_cell_comm.engine import FrontierDomainEngine
from spatial_cell_comm.agents import SpatialDelaunayMeshAgent, LigandReceptorPairMatcherAgent, SignalingPathwayPermutationAgent, SpatialCellCommCoordinator
from spatial_cell_comm.cli import main


def test_sub_agents():
    a1 = SpatialDelaunayMeshAgent()
    ...
    a2 = LigandReceptorPairMatcherAgent()
    ...
    a3 = SignalingPathwayPermutationAgent()
...
def test_coordinator():
    coord = SpatialCellCommCoordinator()
    ...
    assert "Spatial Transcriptomics & CellChat Protocols" in ans or "specifications" in ans
