"""
Automated Pytest for spatial-transcriptomics-cell-cell-agent Enrichment Modules.
"""
import sys
...
from enrichment import (
    FeaturesEngine,
    SpatialtranscriptomicscellcellagentEnrichmentSuite,
    enrichment_suite,
)

def test_enrichment_suite_execution():
    suite = SpatialtranscriptomicscellcellagentEnrichmentSuite()
